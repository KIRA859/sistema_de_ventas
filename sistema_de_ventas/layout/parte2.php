<!-- Main Footer -->
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2025 <a href="https://adminlte.io">Daniel Arias</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
